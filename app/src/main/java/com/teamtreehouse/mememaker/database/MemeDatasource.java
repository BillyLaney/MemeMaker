...
public class MemeDatasource
{
    ...
    public void update(Meme meme)
    {
        ...
        for(MemeAnnotation annotation : meme.getAnnotations())
        {
            ...
            updateAnnotation.put(MemeSQLiteHelper.COLUMN_ANNOTATION_TITLE, annotation.getTitle());
            updateAnnotation.put(MemeSQLiteHelper.COLUMN_ANNOTATION_X, annotation.getLocationX());
            updateAnnotation.put(MemeSQLiteHelper.COLUMN_ANNOTATION_Y, annotation.getLocationY());
            updateAnnotation.put(MemeSQLiteHelper.COLUMN_FOREIGN_KEY_MEME, meme.getId());
            updateAnnotation.put(MemeSQLiteHelper.COLUMN_ANNOTATION_COLOR, annotation.getColor());
    ...
    public void delete(int memeId)
    {
        ...
        database.delete(MemeSQLiteHelper.MEMES_TABLE, String.format("%s=%s", BaseColumns._ID, String.valueOf(memeId)), null);
